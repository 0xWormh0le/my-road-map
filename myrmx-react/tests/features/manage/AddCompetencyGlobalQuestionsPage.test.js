...
import { AddCompetencyGlobalQuestionsPage } from '../../../src/features/manage';
...
it('renders node with correct class name', () => {
  ...
  expect(renderedComponent.find('.manage-add-competency-global-questions-page').length).toBe(1);
});
